            ...
            const loadChatHistory = async () => {
                ...
                try {
                    ...
                    if (history && history.length > 0) {
                        // Có lịch sử trong vòng 1 giờ - hiển thị lại conversation
                        const formattedHistory = history.flatMap((item, index) => [
                        ...
                        // Không có lịch sử - có thể là lần đầu hoặc đã quá 1 giờ
                        // Giữ nguyên session ID để có thể lưu chat mới
